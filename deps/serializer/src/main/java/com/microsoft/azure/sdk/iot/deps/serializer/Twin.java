...
public class Twin
{
    ...
    private static final String propertiesTag = "properties";
    ...
    public JsonElement toJsonElement()
    {
        ...
        if(tags != null) {
            ...
            twinJson.add(tagsTag, tags.toJsonElement());
        }
        ...
        twinJson.add(propertiesTag, properties.toJsonElement());
    ...
    public void updateTwin(String json) throws IllegalArgumentException
    {
        ...
        if((json != null) && (!json.isEmpty())) {
            ...
            for (Map.Entry<String, Object> entry : jsonTree.entrySet()) {
                if (entry.getKey().equals("properties")) {
                ...
                } else if ((entry.getKey().equals("desired")) || (entry.getKey().equals("reported"))) {
                    ...
                    tags.fromJson((Map<String, Object>) entry.getValue());
                    propertiesLevel = true;
                } else {
                    throw new IllegalArgumentException("Invalid Entry");
                }
