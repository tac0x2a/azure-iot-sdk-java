...
public class TwinTagsTest {
    ...
    public void constructor_NULL_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_empty_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_big_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
        ...
        // Act
        new TwinTags(bigString_150chars, sampleTag1);
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalDOT_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
        ...
        // Act
        new TwinTags("illegal.tag", sampleTag1);
    ...
    /* Tests_SRS_TWIN_TAGS_21_007: [If the `tag` has a illegal  character, the constructor shall throw IllegalArgumentException.] */
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalSPACE_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
    ...
    /* Tests_SRS_TWIN_TAGS_21_007: [If the `tag` has a illegal  character, the constructor shall throw IllegalArgumentException.] */
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalDOLLAR_tag_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "Value1");
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_NULL_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_empty_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_big_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalDOT_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    /* Tests_SRS_TWIN_TAGS_21_011: [If the any `tagProperty` key has a illegal  character, the constructor shall throw IllegalArgumentException.] */
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalSPACE_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    /* Tests_SRS_TWIN_TAGS_21_011: [If the any `tagProperty` key has a illegal  character, the constructor shall throw IllegalArgumentException.] */
    @Test (expected = IllegalArgumentException.class)
    public void constructor_illegalDOLLAR_key_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_NULL_value_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
    ...
    @Test (expected = IllegalArgumentException.class)
    public void constructor_empty_value_failed() throws IllegalArgumentException
    {
        // Arrange
        HashMap<String,Object> sampleTag1 = new HashMap<>();
        sampleTag1.put("Key1", "");
